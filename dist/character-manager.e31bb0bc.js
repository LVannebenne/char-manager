...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"utils.js":[function(require,module,exports) {
"use strict"; // Character Manager project
//
...
},{}],"node_modules/showdown/dist/showdown.js":[function(require,module,exports) {
var define;
...
},{}],"api-routes.js":[function(require,module,exports) {
"use strict"; // Character Manager project
//
// Team Ayse Akdede - Lindsay Vannebenne
// BeCode.org - Jepsen 2.14 / Hamilton 2.12
...
function displayAllCharacter(char) {
  ...
  clone.querySelector("#delete").onclick = function () {
    routeDeleteChar(char.id);
  };

  clone.querySelector("#modify").onclick = function () {
    routeEditChar(char.id);
  };

  clone.querySelector(".wrapper").onclick = function () {
    routeViewChar(char.id);
  };
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , axios_1.default.delete(url + "characters/" + id).then(function (response) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , axios_1.default.get(url + "characters").then(function (data) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , axios_1.default.get(url + "characters/" + id).then(function (response) {
            ...
            utils_1.newChar.onclick = function () {
              updateChar(utils_1.formChar);
            };
          })];
...
},{"axios":"node_modules/axios/index.js","./utils":"utils.js","showdown":"node_modules/showdown/dist/showdown.js"}],"index.js":[function(require,module,exports) {
"use strict"; // Character Manager project
//
// Team Ayse Akdede - Lindsay Vannebenne
// BeCode.org - Jepsen 2.14 / Hamilton 2.12
...
},{"axios":"node_modules/axios/index.js","./api-routes":"api-routes.js","./utils":"utils.js"}],"../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "36779" + '/');
...
//# sourceMappingURL=/character-manager.e31bb0bc.js.map